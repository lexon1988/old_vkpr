		...
		echo "<p>Вы будете перенаправлены через <font class='font2'><span id='timer'></span></font> секунд.</p></font>";
			...
			//echo $error_code[1].': '.$error_msg[1];
										...
										<?php
														...
														<?php
														echo "<font class='font2'><img src='http://".$_SERVER['SERVER_NAME']."/img/icon-erroralt.png'> Вы привыслили лимит по отправке сообщений.</font>";
																				...
																				<?php
																				echo "<font class='font2'><img src='http://".$_SERVER['SERVER_NAME']."/img/icon-erroralt.png'> Пользователь ограничил доступ к личным сообщениям.</font>";
