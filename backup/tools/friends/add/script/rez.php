...
<div class='main' >
<br>
<b><font>Добавить друзей по списку</font></b>
<hr>
<br>
...
preg_match("/\<response\>(.*)\<\/response\>/U", $api, $response);
				...
				echo "<p>Вы будете перенаправлены через <font class='font2'><span id='timer'></span></font> секунд.</p></font>";
								...
								echo "<font class='font2'><img src='http://".$_SERVER['SERVER_NAME']."/img/icon-erroralt.png'> Данного пользователя Вы уже добавляли в друзья</font>";
								echo "<font><p>Вы будете перенаправлены через <font class='font2'><span id='timer'></span></font> секунд.</p></font>";
												...
												<?php
																		...
																		<?php
																		echo "<font class='font2'><img src='http://".$_SERVER['SERVER_NAME']."/img/icon-erroralt.png'> Вы превысили лимит, в сутки можно добовлять не более 50 пользователей в друзья</font>";
																		?>
