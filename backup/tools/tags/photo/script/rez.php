	...
	$friend=file('files/'.$uid.'_phototag.txt');
				...
				<html>
						...
						<body onLoad="tiktak();">
							...
							<br>
							<b><font>Отметить на фото</font></b>
						<hr>
					...
					//***CURL-END******CURL-END******CURL-END******CURL-END******CURL-END******CURL-END******CURL-END******CURL-END***
						...
						<?php
						echo "<font class='font2'><img src='http://".$_SERVER['SERVER_NAME']."/img/icon-erroralt.png'>Ошибка: ".$error_code[1].":".$error_msg[1]."</font>"; 
						echo "<p><font>Вы будете перенаправлены через <font class='font2'><span id='timer'></span></font> секунд.</p></font>";
											  }
										...
										<?php
										echo "<font class='font2'><img src='http://".$_SERVER['SERVER_NAME']."/img/icon-erroralt.png'>Ошибка: ".$error_code[1].":".$error_msg[1].". Обычно данная ошибка выходит когда отмечено максимальное кол- во пользователей. Если вы уверены что это не так, перейдите по- <a href='counter.php?max=".$true_max."'>>>></a></font>"; 
