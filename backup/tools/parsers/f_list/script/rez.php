...
<br>
<b><font>Парсер друзей персональной страницы</font></b>
<hr>
...
if($_GET['uid']=="") {echo "<img src='http://".$_SERVER['SERVER_NAME']."/img/icon-erroralt.png'><font class='font2'> Ошибка: Введите id пользователя!</font>"; }
