...
<meta http-equiv="content-type" content="text/html; charset=UTF-8" />
	...
	<body>
<br>
<b><font>Парсер подписчиков сообщества</font></b>
<hr>
<br>
...
<br><img src='http://<?php echo $_SERVER['SERVER_NAME'];?>/img/icon-warning-sign.png' width= 13px; height= 13px;>  
<font size='2' color='red'>Узнать id страны или города вы можете по <a href='help.html'>этой</a> ссылке!
<br><br><img src='http://<?php echo $_SERVER['SERVER_NAME'];?>/img/icon-warning-sign.png' width= 13px; height= 13px;>  
Более 40% пользователей скрывают дату рождения, поэтому фильтр по возрасту иногда даёт довольно мало результатов.
 <br><br><img src='http://<?php echo $_SERVER['SERVER_NAME'];?>/img/icon-warning-sign.png' width= 13px; height= 13px;>  
 Если нужно получить возраст, 2 поля "Годы рождения от/до" должны быть заполнены, или если возраст вам не нужн, оставьте их пустыми.
</font>
