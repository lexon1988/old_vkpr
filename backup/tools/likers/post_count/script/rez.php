...
//(int)($friend[$max]
$api_curl='https://api.vk.com/method/wall.get.xml?owner_id='.(int)($friend[$max]).'&count=1&access_token='.$access_token;
...
preg_match_all("/\<likes\>(.*)\<\/likes\>/uis", $api, $likes);
preg_match("/\<count\>(.*)\<\/count\>/U", $likes[1][0], $count_rez);
...
<div class='main' >
<br>
<b><font>Узнать кол-во лайков на первой записи</font></b>
<hr>
<br>
