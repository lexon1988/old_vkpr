...
<div class='main' >
<br>
<b><font>Лайк на первую запись</font></b>
<hr>
<br>
...
preg_match("/\<error\_code\>(.*)\<\/error\_code\>/U", $api, $error_code);
				...
				//echo $error_code[1].': '.$error_msg[1];
								...
								<?php
								echo "<img src='http://".$_SERVER['SERVER_NAME']."/img/icon-erroralt.png'> <font class='font2'>Что- то не то с: <a href='http://vk.com/wall".$friend[$max]."_".$post."'>http://vk.com/wall".$friend[$max]."_".$post."</a>";
