...
echo "<font>Полученный список можно автоматически добавить в друзья используя инструмент: \"<a href='http://localhost/tools/friends/add/script/'>Добавить друзей из списка</a>\",
 или постваить \"<a href='http://localhost/tools/likers/avatar/script/'>Лайк на аватар</a>\", или \"<a href='http://localhost/tools/likers/post/'>Лайк на первую запись</a>\".";
echo "<br></div></font><br>";
