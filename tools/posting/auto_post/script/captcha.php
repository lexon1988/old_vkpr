...
$api1= "https://api.vk.com/method/wall.post.xml?owner_id=-".$club_id."&message=".$text."&attachments=".$photo."&v=5.0&access_token=".$access_token."&captcha_sid=".$captcha_sid."&captcha_key=".$captcha_key;
	...
	if($comment_id[1]<>""){
						...
						echo "<a href=".$comment_id.">".$comment_id."</a><br></font>";
								...
								if($error_msg[1]<>"") 
								{
								echo "<br><img src='http://localhost/img/icon-erroralt.png'><font class='font2'> Ошибка: ".$error_msg[1]."</font><br><br>";
								}
																...
																if($comment_id[1]<>"")
																	{
																		...
																		echo "<a href=".$comment_id.">".$comment_id."</a><br></font>";	
																					...
																					if($error_msg[1]<>"") echo "<br><img src='http://localhost/img/icon-erroralt.png'><font class='font2'> Ошибка: ".$error_msg[1]."</font><br><br>";
																					}
