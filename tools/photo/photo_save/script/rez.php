...
$api_curl="https://api.vk.com/method/photos.copy.xml?owner_id=".$owner_id."&photo_id=".$photo_id."&access_token=".$access_token;
...
if($response[1]>0){
$api_curl2="https://api.vk.com/method/photos.move.xml?owner_id=".$uid."&photo_id=".(int)($response[1])."&target_album_id=".$album_id."&access_token=".$access_token;
